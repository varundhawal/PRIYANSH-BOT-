...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko kisne banaya ")) {
     return api.sendMessage("🌸====『*★᭄𝗖𝗿𝗲𝗱𝗶𝘁'𝘀  ཫ༄𒁍≛वरुण धावाल *★᭄ ཫ༄𒁍≛ 』====🌸__________________________________ 𝐕𝐀𝐑𝐔𝐍 𝐃𝐇𝐀𝐖𝐀𝐋❤️ Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Latkaye Mat Raha Karo. Har Waqt Haste Raho.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
     return api.sendMessage("🌸====『*★᭄𝗖𝗿𝗲𝗱𝗶𝘁'𝘀  ཫ༄𒁍≛वरुण धावाल *★᭄ ཫ༄𒁍≛ 』====🌸__________________________________ He is 𝐕𝐀𝐑𝐔𝐍 𝐃𝐇𝐀𝐖𝐀𝐋. He Gives his name Mr 𝐕𝐚𝐫𝐮𝐧 𝐃𝐡𝐚𝐰𝐚𝐥 everywhare", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Mai hi tera malik varun") || (event.body.toLowerCase() == "varun dhawal hu bsdk") || (event.body.toLowerCase() == "Mai tera owner hu varun dhawal") || (event.body.toLowerCase() == "Malik hu tera varun")) {
     return api.sendMessage("🌸====『*★᭄𝗖𝗿𝗲𝗱𝗶𝘁'𝘀  ཫ༄𒁍≛वरुण धावाल *★᭄ ཫ༄𒁍≛ 』====🌸__________________________________ सॉरी वरुण धावाल मलिक अब नहीं करूंगा___ 🥺🙏", threadID);
   };
